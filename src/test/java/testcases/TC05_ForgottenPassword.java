...
import pages.P05_ForgottenPassword;
import static drivers.DriverHolder.getDriver;

public class TC05_ForgottenPassword extends TestBase{

    P05_ForgottenPassword forgottenPasswordpage;
    ...
    public void EmailSentWhenPasswordForgotten_P() throws InterruptedException {
        forgottenPasswordpage=new P05_ForgottenPassword(getDriver());
